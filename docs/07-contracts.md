...
`message` безопасен для отрисовки, и санитизация стоит **в конструкторах диагностики**, а не
...
lock-файла. Побочный эффект санитизации полезен: сообщение становится однострочным.
