...
// Стадия `approval` — E5. Брокер, хранилище разрешений и правило выбора опасного токена.
// Каналы сюда НЕ входят: и окно Electron, и elicitation живут в других процессах и приезжают
// портом. Ядро без импортов Electron — ADR-0001, и порт ровно эту границу и держит.
