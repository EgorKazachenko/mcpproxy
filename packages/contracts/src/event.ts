...
export interface AuditEvent {
   ...
   * там, где был вырезан секрет. Нефинитное число или дырка в массиве роняют канонизацию
   * так же, как это сделала бы строка, — «числа безопасны» верно только при этом инварианте.
   */
